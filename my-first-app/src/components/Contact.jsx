const Contact = () => {
    return(
        <>
        <section id="contact" className="mt-4 mb-3 border border-rounded">
            <form>
                <div className="container">
                    <div className="row">
                        <h3 className=" contact_heading mt-3 mb-3"> Contact</h3>
                        
                        <div className="col-md-6 border border-dark info_form">
                            <div className="row p-3">
                                <div className="col-md-10 mb-3">
                                    <label for="forname" className="form-label">Enter full name</label>
                        ...
                        <div className="  col-md-6 P-3">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d60278.274760335524!2d72.95155640833875!3d19.221732869330697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTnCsDEzJzAxLjgiTiA3MsKwNTgnNTIuMiJF!5e0!3m2!1sen!2sin!4v1778667584459!5m2!1sen!2sin" width="620" height="600" style={{border:0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
